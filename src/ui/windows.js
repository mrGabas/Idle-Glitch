...
export class MailWindow {
    ...
    getLines(ctx, text, maxWidth) {
        // Reuse getLines from Notepad or duplicate here for simplicity (avoiding inheritance complexity for now)
        // Since getLines is not static in NotepadWindow and not exported, I'll copy it.
        // Ideally we'd move it to UTILS but this is faster.
        var words = text.split(/[\s\n]+/); // Split by space or newline logic needed better handling for explicit \n
        // Simple manual split by \n first
